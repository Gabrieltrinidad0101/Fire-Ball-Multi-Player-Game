...
export default function Game(): JSX.Element {
  ...
  const fetchData = async () => {
    ...
    if (sessionStorage.getItem("gameId") !== gameId) window.location.reload();
    ...
    const question = (event: any) => {
      event.returnValue =
        "Are you sure you want to leave? If you leave, you're going to die";
    };
